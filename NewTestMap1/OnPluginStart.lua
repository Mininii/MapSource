function init()
	...
	SetWeaponsDatX(2, {DmgBase=100,DmgFactor=250,Cooldown=1}) --Terran Ghost
	SetWeaponsDatX(11, {DmgBase=160,DmgFactor=250,Cooldown=1}) --Terran Siege Tank
	SetWeaponsDatX(27, {DmgBase=80,DmgFactor=120,Cooldown=20}) --Terran Siege Tank Mode
	SetWeaponsDatX(4, {DmgBase=70,DmgFactor=190,Cooldown=1}) --Terran Vulture
	SetWeaponsDatX(7, {DmgBase=45,DmgFactor=140,Cooldown=1}) --Terran Goliath
	SetWeaponsDatX(16, {DmgBase=50,DmgFactor=100,ObjectNum=2,Cooldown=1}) --Terran Wraith
	SetWeaponsDatX(34, {DmgBase=65535}) --Irradiate
	SetWeaponsDatX(33, {DmgBase=65535,Splash={64,64,64}}) --EMP
	SetWeaponsDatX(19, {DmgBase=250,DmgFactor=256,Cooldown=1}) --Terran Battlecruiser
	...
	SetWeaponsDatX(66, {DmgBase=1000,DmgFactor=127,ObjectNum=2,Cooldown=1}) --Protoss Dragoon
	...
	SetWeaponsDatX(81, {DmgBase=20,DmgFactor=80,ObjectNum=2,Cooldown=1,UpgradeType=13,Behavior=2}) -- Protoss Photon Cannon
	SetWeaponsDatX(80, {DmgBase=20,DmgFactor=80,ObjectNum=2,Cooldown=1,UpgradeType=13,Behavior=2}) -- Protoss Photon Cannon
	...
	SetWeaponsDatX(38, {DmgBase=38,DmgFactor=127,ObjectNum=2,Cooldown=1}) -- Zerg Hydralisk
	SetWeaponsDatX(109, {DmgBase=60,DmgFactor=90,RangeMax=224,ObjectNum=2}) -- Zerg Lurker
	SetWeaponsDatX(48, {DmgBase=1000,DmgFactor=127,ObjectNum=2,Cooldown=1}) -- Zerg Mutalisk
	SetWeaponsDatX(46, {DmgBase=250,DmgFactor=75,ObjectNum=2,Splash={10,20,30}}) -- Zerg Guardian
	...
	SetWeaponsDatX(50, {DmgBase=12,DmgFactor=60,ObjectNum=2,Splash={10,15,20},RangeMax=7*32,Cooldown=15}) -- Zerg Defiler
	...
	SetUnitsDatX(100, {Reqptr=8,isHero=true,RdySnd=229,HP=100,Shield=255,MinCost=10000,GasCost=25000,SuppCost=9,BuildTime=85,SeekRange=128})
	...
	SetWeaponsDatX(6, {DmgBase=32767,DmgFactor=128,ObjectNum=2,Splash={8192,8192,8192}}) --Spider Mine
	...
	SetUnitsDatX(81, {Reqptr=223,isHero=true,HP=250,Shield=3,MinCost=65000,GasCost=65000,SuppCost=30,BuildTime=85,AdvFlag={4+0x20000000 ,4+0x20000000 }})
	SetUnitsDatX(85, {AdvFlag={4,4}})
	SetWeaponsDatX(82, {DmgBase=400,DmgFactor=120,Splash={64,96,128}}) --Warbringer Scarab -- 1틱
	--30 * 1 * 1500 = 45000, 스플범위 넓은거 고려하여 너프 필요. 현재 31000
	...
	SetUnitsDatX(48, {Reqptr=116,isHero=true,HP=700,Shield=500,MinCost=30000,GasCost=65000,SuppCost=20,BuildTime=170,SeekRange=6})
