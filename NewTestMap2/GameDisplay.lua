function GameDisplay()
	...
	CIf(FP, {CV(InterfaceNumLoc,1,AtLeast),CV(InterfaceNumLoc,512,AtMost)})
		...
		CColor1_1 = CreateVarArr(4,FP)
		CColor2_1 = CreateVarArr(4,FP)
		...
		MToggle1_1 = CreateCcodeArr(4)
		MToggle2_1 = CreateCcodeArr(4)
		MToggle3_1 = CreateCcodeArr(4)
		MToggle1_2 = CreateCcodeArr(4)
		MToggle2_2 = CreateCcodeArr(4)
		MToggle3_2 = CreateCcodeArr(4)
		...
		for j,p in pairs({0x1F,0x1C,0x1E,0x1D}) do
		...
		for j,p in pairs({0x11,0x1C,0x1F,0x02}) do
...
--		CIfXEnd()
		...
		CElseIfX({CV(InterfaceNumLoc,2)})
			...
			DisplayPrint(LCP, {CColor4_1[4][2],"[+1] ",CColor5_1[4][2],"[+10] ",CColor6_1[4][2],"[+100] ",CColor1_1[4][2],FXPer47Loc,"개 특급 보석 ",CColor3_1[4][2],"개당 "..Cost_FXPer47.." 조각\x12",CColor3_2[4][2],"개당 "..Cost_FMEPer.." 조각 ",CColor1_2[4][2],"궁극의 보석 ",FMEPerLoc,"개 ",CColor6_2[4][2],"[+100] ",CColor5_2[4][2],"[+10] ",CColor4_2[4][2],"[+1]"})
	...
	local StatPrintEr2 = {
		...
		StrDesign("\x04개당 \x0F0.01%p\x04의 \x0247강 \x08강화확률 \x04증가"),
}
	local StatPrintEr3 = {
