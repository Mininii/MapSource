function Include_Vars()
	...
	PushLevelUnit(25+10,20000,1600000/2,40,42,48,800,59)--곰



	PushLevelUnit(25+11,16000,3000000/2,10,26,72,600,59)--파벳영웅 3타
	PushLevelUnit(25+12,12000,8000000/2,75,85,24,1200,59)--제라툴
