function Include_Vars()
	...
	PushLevelUnit(15,35000,0,83,115,72,1300,59,nil,1)--리버
	PushLevelUnit(16,30000,0,70,73,48,1000,59)--스카웃
	PushLevelUnit(17,30000,0,60,100,48,1300,59)--커세어
	PushLevelUnit(18,30000,0,71,77,48,1800,59)--아비터


	
	PushLevelUnit(19,30000,0,37,35,12,600,59)--저글링
	PushLevelUnit(20,25000,0,38,38,24,2000,59)--히드라
	PushLevelUnit(21,25000,0,43,48,24,2700,59)--뮤탈
	PushLevelUnit(22,25000,0,44,46,48,7000,59)--가디언
	PushLevelUnit(23,25000,0,62,104,48,10000,59)--디바우러
	PushLevelUnit(24,25000,0,39,40,48,13000,59)--울트라
	PushLevelUnit(25,10000,0,46,50,12,5000,59)--디파



	PushLevelUnit(25+1,25000,1,20,1,24,10,60)--짐레
	PushLevelUnit(25+2,25000,2,16,3,48,30,59)--사라
	PushLevelUnit(25+3,25000,5,19,5,24,20,59)--짐레벌쳐
	PushLevelUnit(25+4,25000,10,17,10,24,30,59,1,1)--알랜
	PushLevelUnit(25+5,25000,15,23,12,48,100,59,1)--듀크
	PushLevelUnit(25+6,25000,25,53,39,24,80,59)--헌터
	PushLevelUnit(25+7,20000,40,52,51,24,150,59)--언클린
	PushLevelUnit(25+8,20000,75,69,53,72,700,59)--셔틀
	PushLevelUnit(25+9,20000,100,41,43,24,350,59)--드론
	PushLevelUnit(25+10,20000,125,40,42,48,800,59)--곰



	PushLevelUnit(25+11,16000,250,10,26,72,600,59)--파벳영웅 3타
	PushLevelUnit(25+12,16000,1000,75,85,24,1200,59)--제라툴
	PushLevelUnit(25+13,13000,10000,29,21,48,6000,59)--노라드
	PushLevelUnit(25+14,13000,100000,86,78,48,10000,59)--다니모스
	PushLevelUnit(25+15,5000,1000000,54,36,1,5000,59,nil,1)--디버링원 공속최대
