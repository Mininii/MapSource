...
function SCA.SaveCmp(CP)--사용가능 + 저장완료
	...
	TestShop2 = CreateVarArr(7, FP) -- 테스트용이었는데 잘작동해서 유닛 자판기에 사용중
...
--	PushLevelUnit(25+10,20000,3000000/2,40,42,48,1200,59)--곰
	...
	PushLevelUnit(25+11,16000,5000000/2,10,26,48,750,59)--파벳영웅 3타
	...
	SetWeaponsDatX(26,{WepName=1448})--파벳3연타 예외처리
