function Install_CallTriggers()
	...
	function StatBuyFunc(KeyID,StatID,Cost,Multiplier,Max,SendTxt,ErrTxt)
		...
		CIf(FP,{MSQC_TKeyInput(GCP, KeyID)})
			...
			CIfX(FP, {CV(GetPStatData,Cost,AtLeast),CV(GetPStatData,0x7FFFFFFF,AtLeast),CV(TempSID,Max-1,AtMost)},{SubV(GetPStatData,Cost),AddV(TempSID,Multiplier)})
...
for i = 45, 48 do
	...
	CIf(FP,{TMemory(0x512684,Exactly,GCP)})
		CAdd(FP,iv.GFfragLoc,pifrag[i-44])
	CIfEnd()
...
CIfX(FP,{TTNWar(GetCreditData, AtLeast,_LMul({GetMulOp,0}, "100")),TTNWar(GetCreditData, AtMost, "0x7FFFFFFFFFFFFFFF")},{})
...
CIfX(FP,{TTNWar(GetCreditData, AtLeast,_LMul({GetMulOp,0}, "100000")),TTNWar(GetCreditData, AtMost, "0x7FFFFFFFFFFFFFFF")},{})
...
CIfX(FP,{CV(GetVAccData,GetMulOp,AtLeast),CV(GetVAccData,0x7FFFFFFF,AtMost)},{})
...
CIfX(FP,{CV(GetOldTicket,GetMulOp,AtLeast),CV(GetOldTicket,0x7FFFFFFF,AtMost)},{})
...
CIfX(FP,{CV(GetPETicket,GetMulOp,AtLeast),CV(GetPETicket,0x7FFFFFFF,AtMost)},{})
	
	CSub(FP,GetPETicket,GetMulOp)
	f_LAdd(FP, GetBuyTicket,GetBuyTicket, _LMul({GetMulOp,0}, "50000"))
	local TempV = CreateVar(FP)
	CMov(FP,TempV,GetMulOp)
