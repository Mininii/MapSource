function TBL()
	...
	TStr4, TStr4a, TStr4s = SaveiStrArrX(FP,t06)
	TStr5, TStr5a, TStr5s = SaveiStrArrX(FP,t08)
	TStr6, TStr6a, TStr6s = SaveiStrArrX(FP,t13)
	TStr7, TStr7a, TStr7s = SaveiStrArrX(FP,t14)
	...
	EStr0, EStr0a, EStr0s = SaveiStrArrX(FP,t04)
	EStr1, EStr1a, EStr1s = SaveiStrArrX(FP,t05)
	EStr2, EStr2a, EStr2s = SaveiStrArrX(FP,t07)
	EStr3, EStr3a, EStr3s = SaveiStrArrX(FP,t11)
