function TBL()
	...
	for j, k in pairs(PersonalUIDArr) do
		...
		CS__lItoCustom(FP,SVA1(MarStr[j],2),PUnitClassLoc,nil,nil,{10,3},1,nil,"\x03초",0x07)
...
-- CS__ItoCustom(FP,SVA1(Str1,8),StatPLoc,nil,nil,{10,6},1,nil,"\x1C0",0x1C,{0,1,2,4,5,6}, nil,{0,0,{0},0,0,{0}})
	...
	CIf(FP,{CD(XEperFlag,3)},{DisplayText(StrDesignX("45강 유닛 뽑기 확률표").."\n", 4)})
	CIfEnd()
	CIf(FP,{CD(XEperFlag,4)},{DisplayText(StrDesignX("46강 유닛 뽑기 확률표").."\n", 4)})
	CIfEnd()
	CIf(FP,{CD(XEperFlag,5)},{DisplayText(StrDesignX("47강 유닛 뽑기 확률표").."\n", 4)})
	CIfEnd()
	CIf(FP,{CD(XEperFlag,6)},{DisplayText(StrDesignX("48강 유닛 뽑기 확률표").."\n", 4)})
	CIfEnd()
