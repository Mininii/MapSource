function Include_Vars()
	...
	SetUnitAbility(21,18,3,17000,nil,30,450,false,1,160,5,45000,"Kazansky",2000)
	SetUnitAbility(25,28,1,20000,nil,75,1000,false,1,384,12,30000,"Duke Siege",3000)
	SetUnitAbility(17,9,3,15000,nil,1,330,false,1,160,5,35000,"Schezar",2500)

	SetUnitAbility(19,5,3,30000,nil,22,550,false,1,160,5,65000,"Raynor V",4000)
	SetUnitAbility(28,23,3,35000,nil,22,680,false,1,192,6,40000,"Hyperion",5000)
	...
	SetUnitAbility(12,20,4,120000,50000,15,1100,false,1,224,7,220000,"Rose",15000)
	SetUnitAbility(34,94,4,80000,30000,15,850,false,1,160,5,120000,"Jisoo",10000)
	SetUnitAbility(15,25,3,30000,30000,15,400,{10,20,30},1,96,3,70000,"Dalry",5000)
	...
	SetUnitAbility(52,51,3,75000,25000,15,1500,false,1,32*7,4,140000,"Yuri",10000)
	...
	SetUnitAbility(60,100,4,100000,50000,8,550,{5,50,100},1,32*5,9,180000,"Nina",19000)
	SetUnitAbility(70,74,1,150000,60000,15,3000,false,1,32*7,7,200000,"Sera",22000)
	...
	SetUnitAbility(74,86,4,210000,40000,22,1666,nil,1,32*1,4,120000,"Leon",3800)
	...
	SetUnitAbility(77,65,3,20000,nil,15,350,false,2,32*2,3,35000,"Fenix Z",1800)
	SetUnitAbility(78,67,3,25000,nil,15,320,false,1,32*5,5,45000,"Fenix D",2800)
	...
	SetUnitAbility(81,29,4,1,60000,15,640,false,1,32*4,4,70000,"Yuna",5500)
	...
	SetUnitAbility(87,88,4,110000,40000,15,1500,false,1,32*4,3,114000,"Gaya",9500)
	SetUnitAbility(88,114,3,15000,5000,22,500,false,1,32*4,4,35000,"Artanis",3200)
	SetUnitAbility(93,26,4,78000,25000,15,600,false,1,32*1,2,120000,"Yona",11000)
	...
	SetUnitAbility(102,22,5,222222,nil,30,2550,nil,1,224,7,500000,"Division",25000)
	SetUnitAbility(23,12,5,444444,nil,37,3500,nil,1,224,7,400000,"Deaths",35000)
	SetUnitAbility(27,70,5,500000,nil,30,4200,{30,30,30},1,64,5,500000,"Zero",50000)
	SetUnitAbility(68,70,5,777777,65535,30,4200,{30,30,30},1,64,4,777777,"Destroy",60000)
	SetUnitAbility(30,27,5,322,nil,75,3222,nil,1,384,12,96666,"Identity",5000)


	
	SetUnitAbility(61,111,5,1550000,65535,1,3999,nil,1,32*4,1,800000,"DIEIN",500000)
	SetUnitAbility(63,19,5,1350000,65535,25,2111,{45,45,45},1,32*4,3,1000000,"PLAY",500000)
	SetUnitAbility(67,68,5,1880000,65535,15,1444,{60,60,60},1,32*4,3,1400000,"EL CLEAR",700000)
	SetUnitAbility(71,77,5,1450000,65535,30,3777,nil,1,32*5,5,1100000,"LENA",400000)
	SetUnitAbility(89,90,5,1950000,65535,15,3333,nil,1,32*9,9,1500000,"EL FAIL",800000)
