function Test_LV1()
    if Limit == 1 then
        Trigger2(FP,{ElapsedTime(AtLeast,65)},{ModifyUnitHitPoints(All,"Men",P8,64,0),RotatePlayer({DisplayTextX("\x13\x07Å×½ºÆ® ¸ðµå \x04Æ¯Àü! ¸ðµç À¯´ÖÀ» 1È¸ ²ø¾î´ç±é´Ï´Ù."),PlayWAVX("staredit\\wav\\button3.wav"),PlayWAVX("staredit\\wav\\button3.wav"),PlayWAVX("staredit\\wav\\button3.wav")},HumanPlayers,FP)})
