...
SetCall(FP)
		...
		f_LMov(FP, TempLvHP_L7, _LMul(_LDiv(TempLvHP_L4, "256"), {HPMul,0}), nil,nil, 1)
		f_LMovX(FP, WArr(MaxHPWArr,UnitIDV), TempLvHP_L7,SetTo,nil,nil,1)
		CTrigger(FP,{TTCWar(FP,TempLvHP_L7[2],AtLeast,"2129920000")},{SetCWar(FP,TempLvHP_L7[2],SetTo,"2129920000")},{preserved})
		CTrigger(FP,{TTCWar(FP,TempLvHP_L7[2],AtMost,"255")},{SetCWar(FP,TempLvHP_L7[2],SetTo,"256")},{preserved})
		f_Cast(FP,{TempLvHP2,0},TempLvHP_L7,nil,nil,1) 
