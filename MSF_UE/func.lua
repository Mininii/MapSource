...
function BGMManager()
	...
	IdenBGM = AddBGM(9,"staredit\\wav\\JinjinZzara.ogg",224*1000)
	...
	CIf(FP,{CVar(FP,ReserveBGM[2],AtLeast,1),DeathsX(AllPlayers,AtMost,0,440,0xFFFFFF)})
		...
		TriggerX(FP,{Bring(FP,AtLeast,1,68,64)},{SetCVar(FP,BGMTypeV[2],SetTo,roka7BGM),SetCVar(FP,ReserveBGM[2],SetTo,IdenBGM)},{Preserved})
	CIfEnd()
