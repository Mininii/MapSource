...
function InstallGunData()
	...
	function Case_Overmind()
		...
		CIf(FP,Gun_Line(4,AtLeast,15000))
			G_CA_SetSpawn(Gun_Line(5,Exactly,0),G_L1,{56,77},{"ACAS","ACAS"},{Ovrm_1,Ovrm_1},{255,255})
			G_CA_SetSpawn(Gun_Line(5,Exactly,1),G_L1,{56,76},{"ACAS","ACAS"},{Ovrm_1,Ovrm_1},{255,255})
			...
			CIf(FP,{Gun_Line(4,AtLeast,15000),G_CA_CondStack})
				CIf(FP,Gun_Line(3,Exactly,0))
					...
					CIf(FP,{LvT(AtLeast,7),LvT(ATMost,9)})
						CIf(FP,Gun_Line(5,Exactly,0))
							G_CA_SetSpawn(nil,G_L1,{88,56},{P_5,S_6},{2,2})
							G_CA_SetSpawn(nil,G_L2,{54,104},{S_4,S_4},{1,1})
							G_CA_SetSpawn(nil,G_L3,{51,48},{S_3,S_4},{1,1})
							G_CA_SetSpawn(nil,G_L4,{48,53,77,78},{S_8,S_6,P_5,S_4},{1,1,4,1})
						CIfEnd()
						CIf(FP,Gun_Line(5,Exactly,1))
							G_CA_SetSpawn(nil,G_L1,{28,56},{P_6,S_6},{1,2})
							G_CA_SetSpawn(nil,G_L2,{54,104},{S_3,S_3},{3,1})
							G_CA_SetSpawn(nil,G_L3,{51,48},{S_3,S_3},{3,1})
							G_CA_SetSpawn(nil,G_L4,{48,53,79,75},{S_8,S_6,P_7,P_5},{1,1,2,2})
						CIfEnd()
					CIfEnd()
					CIf(FP,{LvT(Exactly,10)})
						CIf(FP,Gun_Line(5,Exactly,0))
							G_CA_SetSpawn(nil,G_L1,{98,56},{S_3,S_8},{1,2})
							G_CA_SetSpawn(nil,G_L2,{54,104},{S_4,S_4},{1,1})
							G_CA_SetSpawn(nil,G_L3,{51,48},{S_3,S_4},{1,1})
							G_CA_SetSpawn(nil,G_L4,{48,53,79,75},{S_8,S_6,P_7,P_5},{1,1,2,2})
						CIfEnd()
						CIf(FP,Gun_Line(5,Exactly,1))
							G_CA_SetSpawn(nil,G_L1,{29,56},{S_7,S_8},{0,2})
							G_CA_SetSpawn(nil,G_L2,{54,104},{S_3,S_3},{1,3})
							G_CA_SetSpawn(nil,G_L3,{51,48},{S_3,S_3},{1,3})
							G_CA_SetSpawn(nil,G_L4,{48,53,76,19},{S_8,S_6,S_5,P_4},{1,1,2,3})
						CIfEnd()
					CIfEnd()
				CTrigger(FP,{Gun_Line(5,AtLeast,1),G_CA_CondStack},{Gun_DoSuspend()},1)
				CIfEnd()
				CIf(FP,Gun_Line(3,Exactly,1))
					CIf(FP,{LvT(ATMost,3)})
						...
						G_CA_SetSpawn(Gun_Line(5,Exactly,0),G_L1,{48,55},{"ACAS","ACAS"},{Hive_2,Hive_2},{255,255})
						G_CA_SetSpawn(Gun_Line(5,Exactly,1),G_L1,{104,56},{"ACAS","ACAS"},{Hive_2,Hive_2},{255,255})
						G_CA_SetSpawn(Gun_Line(5,Exactly,2),G_L1,{51,56},{"ACAS","ACAS"},{Hive_2,Hive_2},{255,255})
					CIfEnd()
					CIf(FP,{LvT(AtLeast,4),LvT(ATMost,6)})
						G_CA_SetSpawn(Gun_Line(5,Exactly,0),G_L1,{51,56},{"ACAS","ACAS"},{Hive_2,Hive_2},{255,255})
						G_CA_SetSpawn(Gun_Line(5,Exactly,1),G_L1,{77,56},{"ACAS","ACAS"},{Hive_2,Hive_2},{255,255})
						G_CA_SetSpawn(Gun_Line(5,Exactly,2),G_L1,{78,88},{"ACAS","ACAS"},{Hive_2,Hive_2},{255,255})
					CIfEnd()
					CIf(FP,{LvT(AtLeast,7),LvT(ATMost,9)})
						G_CA_SetSpawn(Gun_Line(5,Exactly,0),G_L1,{76,56},{"ACAS","ACAS"},{Hive_2,Hive_2},{255,255})
						G_CA_SetSpawn(Gun_Line(5,Exactly,1),G_L1,{25,56},{"ACAS","ACAS"},{Hive_2,Hive_2},{255,255})
						G_CA_SetSpawn(Gun_Line(5,Exactly,2),G_L1,{79,21},{"ACAS","ACAS"},{Hive_2,Hive_2},{255,255})
					CIfEnd()
					CIf(FP,{LvT(Exactly,10)})
						G_CA_SetSpawn(Gun_Line(5,Exactly,0),G_L1,{51,28},{"ACAS","ACAS"},{Hive_2,Hive_2},{255,255})
						G_CA_SetSpawn(Gun_Line(5,Exactly,1),G_L1,{86,21},{"ACAS","ACAS"},{Hive_2,Hive_2},{255,255})
						G_CA_SetSpawn(Gun_Line(5,Exactly,2),G_L1,{75,98},{"ACAS","ACAS"},{Hive_2,Hive_2},{255,255})
					CIfEnd()
				...
				CIf(FP,Gun_Line(3,Exactly,2))
					...
					CIfEnd()
					CIf(FP,{LvT(AtLeast,4),LvT(ATMost,6)})
						Input_CSData(CustomShape[2],56,nil,Gun_Line(5,Exactly,0))
						Input_CSData(CustomShape[2],88,nil,Gun_Line(5,Exactly,1))
						Input_CSData(CustomShape[2],21,nil,Gun_Line(5,Exactly,2))
					CIfEnd()
					CIf(FP,{LvT(AtLeast,7),LvT(ATMost,9)})
						Input_CSData(CustomShape[2],21,nil,Gun_Line(5,Exactly,0))
						Input_CSData(CustomShape[2],28,nil,Gun_Line(5,Exactly,1))
						Input_CSData(CustomShape[2],86,nil,Gun_Line(5,Exactly,2))
					CIfEnd()
					CIf(FP,{LvT(Exactly,10)})
						Input_CSData(CustomShape[2],86,nil,Gun_Line(5,Exactly,0))
						Input_CSData(CustomShape[2],98,nil,Gun_Line(5,Exactly,1))
						Input_CSData(CustomShape[2],29,nil,Gun_Line(5,Exactly,2))
					CIfEnd()
					CallTriggerX(FP,Load_CSArr)
					CTrigger(FP,{Gun_Line(5,AtLeast,2),G_CA_CondStack},{Gun_DoSuspend()},1)
				CIfEnd()
				CIf(FP,Gun_Line(3,Exactly,3))
					...
					CIfEnd()
					CIf(FP,{LvT(AtLeast,4),LvT(ATMost,6)})
						Input_CSData(CustomShape[3],48,55,Gun_Line(5,Exactly,0))
						Input_CSData(CustomShape[3],51,55,Gun_Line(5,Exactly,1))
						Input_CSData(CustomShape[3],104,56,Gun_Line(5,Exactly,2))
					CIfEnd()
					CIf(FP,{LvT(AtLeast,7),LvT(ATMost,9)})
						Input_CSData(CustomShape[3],77,78,Gun_Line(5,Exactly,0))
						Input_CSData(CustomShape[3],25,88,Gun_Line(5,Exactly,1))
						Input_CSData(CustomShape[3],17,21,Gun_Line(5,Exactly,2))
					CIfEnd()
					CIf(FP,{LvT(Exactly,10)})
						Input_CSData(CustomShape[3],19,28,Gun_Line(5,Exactly,0))
						Input_CSData(CustomShape[3],79,98,Gun_Line(5,Exactly,1))
						Input_CSData(CustomShape[3],75,29,Gun_Line(5,Exactly,2))
					CIfEnd()
					CallTriggerX(FP,Load_CSArr)
					CTrigger(FP,{Gun_Line(5,AtLeast,2),G_CA_CondStack},{Gun_DoSuspend()},1)
				CIfEnd()
	...
	function Case_Lair()
		...
		CIf(FP,{Gun_Line(4,AtLeast,15000),G_CA_CondStack})
			...
			CIf(FP,{LvT(AtLeast,7),LvT(AtMost,9)})
				CIf(FP,Gun_Line(5,Exactly,0))
					G_CA_SetSpawn(nil,G_L1,{56},{P_6},{3})
					G_CA_SetSpawn(nil,G_L2,{77,104},{S_7,S_6},{1,1})
					G_CA_SetSpawn(nil,G_L3,{51,48},{S_7,S_6},{1,1})
					G_CA_SetSpawn(nil,G_L4,{48,78},{S_7,S_6},{1,1})
				CIfEnd()
				CIf(FP,Gun_Line(5,Exactly,1))
					G_CA_SetSpawn(nil,G_L1,{56},{P_6},{4})
					G_CA_SetSpawn(nil,G_L2,{77,104},{S_6,S_6},{1,1})
					G_CA_SetSpawn(nil,G_L3,{51,48},{S_6,S_6},{1,1})
					G_CA_SetSpawn(nil,G_L4,{48,78},{S_6,S_6},{1,1})
				CIfEnd()
			CIfEnd()

			CIf(FP,{LvT(Exactly,10)})
				CIf(FP,Gun_Line(5,Exactly,0))
					G_CA_SetSpawn(nil,G_L1,{21,56},{S_6,P_4},{2,5})
					G_CA_SetSpawn(nil,G_L2,{77,104},{S_5,S_6},{1,1})
					G_CA_SetSpawn(nil,G_L3,{51,48},{S_5,S_6},{1,1})
					G_CA_SetSpawn(nil,G_L4,{48,78},{S_5,P_7},{1,3})
				CIfEnd()
				CIf(FP,Gun_Line(5,Exactly,1))
					G_CA_SetSpawn(nil,G_L1,{88,56},{S_5,P_5},{2,4})
					G_CA_SetSpawn(nil,G_L2,{77,104},{S_5,S_6},{2,1})
					G_CA_SetSpawn(nil,G_L3,{51,48},{S_5,S_6},{3,1})
					G_CA_SetSpawn(nil,G_L4,{48,78},{S_5,P_6},{2,3})
				CIfEnd()
			CIfEnd()
