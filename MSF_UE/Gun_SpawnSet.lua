	...
	function Case_Hive()
		...
		CIf(FP,{Gun_Line(4,AtLeast,15000),G_CA_CondStack})
			...
			CIf(FP,Gun_Line(3,Exactly,1))
				...
				CIfEnd()
				CIf(FP,{LvT(AtLeast,4),LvT(ATMost,6)})
					Input_CSData(CustomShape[1],51,56,Gun_Line(5,Exactly,0))
					Input_CSData(CustomShape[1],77,56,Gun_Line(5,Exactly,1))
					Input_CSData(CustomShape[1],78,88,Gun_Line(5,Exactly,2))
				CIfEnd()
				CIf(FP,{LvT(AtLeast,7),LvT(ATMost,9)})
					Input_CSData(CustomShape[1],51,56,Gun_Line(5,Exactly,0))
					Input_CSData(CustomShape[1],25,56,Gun_Line(5,Exactly,1))
					Input_CSData(CustomShape[1],79,21,Gun_Line(5,Exactly,2))
				CIfEnd()
				CIf(FP,{LvT(Exactly,10)})
					Input_CSData(CustomShape[1],51,28,Gun_Line(5,Exactly,0))
					Input_CSData(CustomShape[1],71,21,Gun_Line(5,Exactly,1))
					Input_CSData(CustomShape[1],75,98,Gun_Line(5,Exactly,2))
				CIfEnd()
				CallTriggerX(FP,Load_CSArr)
		...
		CIf(FP,{Gun_Line(4,AtLeast,15000),G_CA_CondStack})
			CIf(FP,{LvT(AtLeast,4),LvT(AtMost,6)})
				CIf(FP,Gun_Line(5,Exactly,0))
					...
					G_CA_SetSpawn(nil,G_L2,{54,104},{S_8,S_6},{0,1})
					G_CA_SetSpawn(nil,G_L3,{51,48},{S_8,S_6},{0,1})
					G_CA_SetSpawn(nil,G_L4,{48,53},{S_8,S_6},{0,1})
				CIfEnd()
				CIf(FP,Gun_Line(5,Exactly,1))
			...
			CIf(FP,{LvT(AtLeast,7),LvT(AtMost,9)})
				CIf(FP,Gun_Line(5,Exactly,0))
					G_CA_SetSpawn(nil,G_L1,{56},{P_6},{3})
					G_CA_SetSpawn(nil,G_L2,{77,104},{S_7,S_6},{0,1})
					G_CA_SetSpawn(nil,G_L3,{51,48},{S_7,S_6},{0,1})
					G_CA_SetSpawn(nil,G_L4,{48,78},{S_7,S_6},{0,1})
				CIfEnd()
				CIf(FP,Gun_Line(5,Exactly,1))
					G_CA_SetSpawn(nil,G_L1,{56},{P_6},{4})
