...
function Objects()
	...
	P_EnchantCost = 300 -- 뉴비를 위한 일마 강화 적용
...
function Var_init()
	...
	EnemyHPT1 = CreateCText(FP,"\x07『 \x08적 체력 \x0E감소 \x04업그레이드 (A, S:일괄구입) \x1F(Cost:40000) \x04(\x0d\x0d\x0d\x0d\x0d\x0d")
	EnemyHPT2 = CreateCText(FP,"/255) \x07』\x0d\x0d\x0d\x0d\x0d\x0d")
