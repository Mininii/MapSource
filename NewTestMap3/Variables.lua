function Include_Vars()
	...
	PushLevelUnit(1,{45000,55000,0,0},0,0,0,24,1,60,nil,50)--마린
	PushLevelUnit(2,{40000,45000,15000,0},0,1,2,72,10,59,nil,200)--고스트
	PushLevelUnit(3,{38000,40000,22000,0},0,2,4,72,30,59,nil,500)--벌쳐
	PushLevelUnit(4,{35000,35000,30000,0},0,7,13,48,40,59,nil,550)--에씨비 
	PushLevelUnit(5,{30000,35000,30000,5000},1,8,16,48,100,59,nil,1000)--레이스
	PushLevelUnit(6,{30000,34000,30000,6000},3,5,11,48,250,59,nil,6000)--탱크
	PushLevelUnit(7,{28000,35000,30000,7000},7,3,7,48,1000,59,nil,35000)--골럇 
	PushLevelUnit(8,{26000,36000,30000,8000},11,32,25,72,1500,59,nil,150000)--파벳 3타 2만원
	PushLevelUnit(9,{24000,37000,30000,9000},15,58,103,48,5000,59,nil,600000)--발키리 2타
	PushLevelUnit(10,{20000,40000,30000,10000},25,12,19,48,12000,59,nil,2500000)--배틀
	PushLevelUnit(11,{18000,38000,34000,10000},40,39,40,24,15000,59,nil,11000000)--울트라
	PushLevelUnit(12,{16000,36000,38000,10000},75,38,38,24,32000,59,nil,38000000)--히드라
	PushLevelUnit(13,{14000,34000,42000,10000},120,43,48,12,30000,59,nil,94000000)--뮤탈
	PushLevelUnit(14,{12000,32000,46000,10000},200,44,46,12,50000,59,nil,500000000)--가디언
	PushLevelUnit(15,{10000,30000,50000,10000},320,37,35,5,60000,59,nil,0)--저글링
