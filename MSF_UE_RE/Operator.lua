...
--        Print13_NumSet(LevelPtr,0x64159C,1000,0x10000)
	...
	if Limit == 1 then
		...
		CMov(FP,0x6509B0,CurrentOP)
			TriggerX(FP,{Deaths(CurrentPlayer,AtLeast,1,224)},{SetCVar(FP,Level[2],Add,1),SetResources(Force1, SetTo, 0x70000000, Ore)},{preserved})
			TriggerX(FP,{Deaths(CurrentPlayer,AtLeast,1,223)},{SetCVar(FP,Level[2],Subtract,1),SetResources(Force1, SetTo, 0x70000000, Ore)},{preserved})
