...
function CIfKey(Key,Conditions,Actions,PreserveFlag,CutFlag)
	if PreserveFlag == 1 then
		if CutFlag ~= 1 then 
			CIfOnce(FP,{TDeaths(KeyCP,AtLeast,1,Key),Conditions},{TSetDeaths(KeyCP,SetTo,0,Key),Actions})
		else
			CIfOnce(FP,{TDeaths(KeyCP,AtLeast,1,Key),Conditions},{Actions})
		end
	else
		if CutFlag ~= 1 then 
			CIf(FP,{TDeaths(KeyCP,AtLeast,1,Key),Conditions},{TSetDeaths(KeyCP,SetTo,0,Key),Actions})
		else
			CIf(FP,{TDeaths(KeyCP,AtLeast,1,Key),Conditions},{Actions})
		end
	end
end
