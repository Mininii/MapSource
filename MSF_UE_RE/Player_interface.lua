function PlayerInterface()
	...
	for i = 0, 6 do -- 각플레이어
		...
		--[==[ [SCR_DB] 데이터 조작 방지(비정상 값 판정 -> BanFlag(데스 149) -> 강퇴)라 이번 버전에서 뺐다.
		-- 저장 목록에서도 BanFlag 를 뺐다(SCR_DB_MSF.lua). 호스트의 강퇴 기능(BanToken)은 그대로다.
