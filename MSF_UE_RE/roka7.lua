...
--	end
	...
	CTrigger(FP,{TDeaths(B_5_C+2, AtMost, 650*256, 0),CV(F2BHP,0)},{SetV(F2BHP,1),TSetDeaths(B_5_C+2,SetTo,_Add(_Mul(LevelT2,1000*256),5555*256),0),SetMemory(0x58F51C,SetTo,1)},1)
	CTrigger(FP,{TDeaths(B_5_C+2, AtMost, 650*256, 0),CV(F2BHP,1)},{SetV(F2BHP,2),TSetDeaths(B_5_C+2,SetTo,_Add(_Mul(LevelT2,2000*256),2000*256),0),SetMemory(0x58F51C,SetTo,2)},1)
