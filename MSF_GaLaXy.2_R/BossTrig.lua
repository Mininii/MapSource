function Install_boss()
	CIf({Force1,FP},{Deaths(P12,AtMost,0,186),CGMode(2,AtLeast),CDeaths(FP,AtLeast,6000,GunBossAct),Bring(Force2, AtMost, 0, "Protoss Temple", 64)},{SetCDeaths(FP,SetTo,1,BossStart),ModifyUnitShields(All,186,FP,64,100)})
		...
		CIf(FP,{CVar(FP,FBH[2],AtLeast,1),CVar(FP,FBH[2],AtMost,19025+(84*1699))})
			...
			CIfOnce(FP,{TMemory(FBH,AtMost,6320000*256)},{SetCDeaths(FP,SetTo,300,BT_0),SetCDeaths(FP,Add,1,B_P),SetCDeaths(FP,SetTo,1,BT_Ready2)})
			DoActions2X(FP, {CopyCpAction({PlayWAVX("staredit\\wav\\HeroKill.ogg"),PlayWAVX("staredit\\wav\\HeroKill.ogg")},HumanPlayers,FP)})
			CIfEnd()
			CIfOnce(FP,{TMemory(FBH,AtMost,4320000*256)},{SetCDeaths(FP,SetTo,300,BT_0),SetCDeaths(FP,Add,1,B_P),SetCDeaths(FP,SetTo,1,BT_Ready2)})
			DoActions2X(FP, {CopyCpAction({PlayWAVX("staredit\\wav\\HeroKill.ogg"),PlayWAVX("staredit\\wav\\HeroKill.ogg")},HumanPlayers,FP)})
			CIfEnd()
			CIfOnce(FP,{TMemory(FBH,AtMost,2320000*256)},{SetCDeaths(FP,SetTo,300,BT_0),SetCDeaths(FP,Add,1,B_P),SetCDeaths(FP,SetTo,1,BT_Ready2)})
			DoActions2X(FP, {CopyCpAction({PlayWAVX("staredit\\wav\\HeroKill.ogg"),PlayWAVX("staredit\\wav\\HeroKill.ogg")},HumanPlayers,FP)})
			CIfEnd()
			CIfOnce(FP,{TMemory(FBH,AtMost,320000*256)},{SetCDeaths(FP,SetTo,300,BT_0),SetCDeaths(FP,Add,1,B_P),SetCDeaths(FP,SetTo,1,BT_Ready2),TSetMemory(FBH,SetTo,8320000*256)})
			DoActions2X(FP, {CopyCpAction({PlayWAVX("staredit\\wav\\HeroKill.ogg"),PlayWAVX("staredit\\wav\\HeroKill.ogg")},HumanPlayers,FP)})
			CIfEnd()
...
--		DoActions(FP,Order(186,FP,64,Move,"Location 31"))
		...
		CIfX(FP,{CountdownTimer(AtMost,0),CDeaths(FP,AtMost,0,BT_0)})
			...
			CIfEnd()
			CIf(FP,CDeaths(FP,Exactly,2,B_P),{SetCDeaths(FP,Add,1,BP2_T2),SetCDeaths(FP,Add,1,BP2_T3)})
				TriggerX(FP,{CGMode(2)},{SetBulletSpeed(700)},{preserved})
				TriggerX(FP,{CGMode(3)},{SetBulletSpeed(350)},{preserved})
			...
			CIf(FP,CDeaths(FP,Exactly,3,B_P),{SetCDeaths(FP,Add,1,BT2)})
				...
				TriggerX(FP,{CGMode(2)},{SetBulletSpeed(700)})
				TriggerX(FP,{CGMode(3)},{SetBulletSpeed(1500)})
