			...
			CIf(FP,Gun_Line(5,AtMost,2))
				...
				CIf(FP,{Gun_Line(0,Exactly,132)}) -- Case Lair
					...
					CIf(FP,CGMode(2)) -- Case Hard
						G_CA_SetSpawn({CVar(FP,UnitIDV1[2],AtLeast,1),CVar(FP,UnitIDV2[2],AtLeast,1)},{UID1I,UID2I},"ACAS",{"L00_1_128F","L00_1_128F"},"MAX")
						G_CA_SetSpawn({CVar(FP,UnitIDV1[2],AtLeast,1),CVar(FP,UnitIDV2[2],Exactly,0)},{UID1I},"ACAS",{"L00_1_128F"},"MAX")
						G_CA_SetSpawn({CVar(FP,UnitIDV3[2],AtLeast,1)},{UID3I},"ACAS",{"L00_1_128F"},"MAX")
						G_CA_SetSpawn({Gun_Line(5,Exactly,0)},ZergUnit1,"ACAS",{"L00_1_64L","L00_1_64F"},"MAX")
						G_CA_SetSpawn({Gun_Line(5,Exactly,1)},ZergUnit2,"ACAS",{"L00_1_64L","L00_1_64F"},"MAX")
						G_CA_SetSpawn({Gun_Line(5,Exactly,2)},ZergUnit3,"ACAS",{"L00_1_64L","L00_1_64F","L00_1_64F"},"MAX")
						G_CA_SetSpawn({CVar(FP,UnitIDV4[2],AtLeast,1)},{UID4I},"ACAS",{"L00_1_96F"},"MAX")



					CIfEnd()
					CIf(FP,CGMode(3)) -- Case Burst
						G_CA_SetSpawn({Gun_Line(5,Exactly,0)},ZergUnit1,{P_4,S_5},{4,2},"MAX")
						G_CA_SetSpawn({Gun_Line(5,Exactly,1)},ZergUnit2,{S_6,P_8},{2,3},"MAX")
						G_CA_SetSpawn({Gun_Line(5,Exactly,2)},ZergUnit3,{P_6,P_5,S_8},{3,3,2},"MAX")
						G_CA_SetSpawn({CVar(FP,UnitIDV4[2],AtLeast,1)},{UID4I},{S_5},{2},"MAX")
						CIf(FP,Gun_Line(5,Exactly,1)) -- 1st
							G_CA_SetSpawn({Gun_Line(3,AtMost,1),CVar(FP,UnitIDV1[2],AtLeast,1)},{UID1I},{S_4},{1},"MAX")
							G_CA_SetSpawn({Gun_Line(3,AtMost,1),CVar(FP,UnitIDV2[2],AtLeast,1)},{UID2I},{P_4},{1},"MAX")
							CIf(FP,{Gun_Line(3,AtLeast,2),Gun_Line(3,AtMost,5)}) -- Lv2~5
								G_CA_SetSpawn({CVar(FP,UnitIDV1[2],AtLeast,1)},{UID1I},{P_6},{1},"MAX")
								G_CA_SetSpawn({CVar(FP,UnitIDV2[2],AtLeast,1)},{UID2I},{S_3},{1},"MAX")
								G_CA_SetSpawn({CVar(FP,UnitIDV3[2],AtLeast,1)},{UID3I},{S_5},{0},"MAX")
							CIfEnd()
							CIf(FP,{Gun_Line(3,AtLeast,6),Gun_Line(3,AtMost,9)}) -- 6~9
								G_CA_SetSpawn({CVar(FP,UnitIDV1[2],AtLeast,1)},{UID1I},{P_6},{1},"MAX")
								G_CA_SetSpawn({CVar(FP,UnitIDV2[2],AtLeast,1)},{UID2I},{S_3},{1},"MAX")
								G_CA_SetSpawn({CVar(FP,UnitIDV3[2],AtLeast,1)},{UID3I},{P_5},{1},"MAX")
							CIfEnd()
							G_CA_SetSpawn({Gun_Line(3,Exactly,10),CVar(FP,UnitIDV1[2],AtLeast,1)},{UID1I},{S_5},{0},"MAX")
							G_CA_SetSpawn({Gun_Line(3,Exactly,10),CVar(FP,UnitIDV2[2],AtLeast,1)},{UID2I},{P_4},{1},"MAX")
							G_CA_SetSpawn({Gun_Line(3,Exactly,10),CVar(FP,UnitIDV3[2],AtLeast,1)},{UID3I},{S_6},{0},"MAX")
							G_CA_SetSpawn({Gun_Line(3,Exactly,11),CVar(FP,UnitIDV1[2],AtLeast,1)},{UID1I},{P_4},{1},"MAX")
							G_CA_SetSpawn({Gun_Line(3,Exactly,11),CVar(FP,UnitIDV2[2],AtLeast,1)},{UID2I},{P_3},{1},"MAX")
							G_CA_SetSpawn({Gun_Line(3,Exactly,11),CVar(FP,UnitIDV3[2],AtLeast,1)},{UID3I},{S_6},{1},"MAX")
						CIfEnd()
						CIf(FP,Gun_Line(5,Exactly,2)) -- 2nd
							G_CA_SetSpawn({Gun_Line(3,AtMost,1),CVar(FP,UnitIDV1[2],AtLeast,1)},{UID1I},{S_4},{1},"MAX")
							G_CA_SetSpawn({Gun_Line(3,AtMost,1),CVar(FP,UnitIDV2[2],AtLeast,1)},{UID2I},{P_7},{1},"MAX")
							CIf(FP,{Gun_Line(3,AtLeast,2),Gun_Line(3,AtMost,5)}) -- Lv2~5
								G_CA_SetSpawn({CVar(FP,UnitIDV1[2],AtLeast,1)},{UID1I},{S_6},{1},"MAX")
								G_CA_SetSpawn({CVar(FP,UnitIDV2[2],AtLeast,1)},{UID2I},{P_4},{3},"MAX")
								G_CA_SetSpawn({CVar(FP,UnitIDV3[2],AtLeast,1)},{UID3I},{P_5},{1},"MAX")
							CIfEnd()
							CIf(FP,{Gun_Line(3,AtLeast,6),Gun_Line(3,AtMost,9)}) -- 6~9
								G_CA_SetSpawn({CVar(FP,UnitIDV1[2],AtLeast,1)},{UID1I},{P_6},{2},"MAX")
								G_CA_SetSpawn({CVar(FP,UnitIDV2[2],AtLeast,1)},{UID2I},{P_4},{3},"MAX")
								G_CA_SetSpawn({CVar(FP,UnitIDV3[2],AtLeast,1)},{UID3I},{P_5},{1},"MAX")
							CIfEnd()
							G_CA_SetSpawn({Gun_Line(3,Exactly,10),CVar(FP,UnitIDV1[2],AtLeast,1)},{UID1I},{P_5},{1},"MAX")
							G_CA_SetSpawn({Gun_Line(3,Exactly,10),CVar(FP,UnitIDV2[2],AtLeast,1)},{UID2I,UID2I},{S_3,S_4},{0,0},"MAX")
							G_CA_SetSpawn({Gun_Line(3,Exactly,10),CVar(FP,UnitIDV3[2],AtLeast,1)},{UID3I},{P_6},{1},"MAX")
							G_CA_SetSpawn({Gun_Line(3,Exactly,11),CVar(FP,UnitIDV1[2],AtLeast,1)},{UID1I},{S_4},{1},"MAX")
							G_CA_SetSpawn({Gun_Line(3,Exactly,11),CVar(FP,UnitIDV2[2],AtLeast,1)},{UID2I},{P_5},{1},"MAX")
							G_CA_SetSpawn({Gun_Line(3,Exactly,11),CVar(FP,UnitIDV3[2],AtLeast,1)},{UID3I},{P_3},{3},"MAX")
						CIfEnd()
					CIfEnd()
				CIfEnd()
				CIf(FP,{Gun_Line(0,Exactly,133)}) -- Case Hive
					...
					CIfEnd()
					CIf(FP,CGMode(2)) -- Case Hard
					G_CA_SetSpawn({CVar(FP,UnitIDV1[2],AtLeast,1),CVar(FP,UnitIDV2[2],AtLeast,1)},{UID1I,UID2I},"ACAS",{"H00_1_96F","H00_1_96F"},"MAX")
					G_CA_SetSpawn({CVar(FP,UnitIDV1[2],AtLeast,1),CVar(FP,UnitIDV2[2],Exactly,0)},{UID1I},"ACAS",{"H00_1_96F"},"MAX")
					G_CA_SetSpawn({CVar(FP,UnitIDV3[2],AtLeast,1)},{UID3I},"ACAS",{"H00_1_96F"},"MAX")
						G_CA_SetSpawn({Gun_Line(5,Exactly,0)},ZergUnit2,"ACAS",{"H00_1_64L","H00_1_64F"},"MAX")
						G_CA_SetSpawn({Gun_Line(5,Exactly,1)},ZergUnit3,"ACAS",{"H00_1_64L","H00_1_64F"},"MAX")
						G_CA_SetSpawn({Gun_Line(5,Exactly,2)},ZergUnit4,"ACAS",{"H00_1_64L","H00_1_64F","L00_1_64F"},"MAX")
						G_CA_SetSpawn({CVar(FP,UnitIDV4[2],AtLeast,1)},{UID4I},"ACAS",{"H00_1_82F"},"MAX")


					CIfEnd()
					CIf(FP,CGMode(3)) -- Case Burst
						G_CA_SetSpawn({Gun_Line(5,Exactly,0)},ZergUnit1,{P_5,S_6},{4,2},"MAX")
						G_CA_SetSpawn({Gun_Line(5,Exactly,1)},ZergUnit2,{S_7,S_5},{2,3},"MAX")
						G_CA_SetSpawn({Gun_Line(5,Exactly,2)},ZergUnit3,{P_7,P_6,P_7},{3,3,4},"MAX")
						G_CA_SetSpawn({CVar(FP,UnitIDV4[2],AtLeast,1)},{UID4I},{S_6},{2},"MAX")
						CIf(FP,Gun_Line(5,Exactly,1)) -- 1st
							G_CA_SetSpawn({Gun_Line(3,AtMost,1),CVar(FP,UnitIDV1[2],AtLeast,1)},{UID1I},{S_6},{1},"MAX")
							G_CA_SetSpawn({Gun_Line(3,AtMost,1),CVar(FP,UnitIDV2[2],AtLeast,1)},{UID2I},{P_5},{2},"MAX")
							CIf(FP,{Gun_Line(3,AtLeast,2),Gun_Line(3,AtMost,5)}) -- Lv2~5
								G_CA_SetSpawn({CVar(FP,UnitIDV1[2],AtLeast,1)},{UID1I},{P_8},{1},"MAX")
								G_CA_SetSpawn({CVar(FP,UnitIDV2[2],AtLeast,1)},{UID2I},{S_5},{1},"MAX")
								G_CA_SetSpawn({CVar(FP,UnitIDV3[2],AtLeast,1)},{UID3I},{S_3},{1},"MAX")
							CIfEnd()
							CIf(FP,{Gun_Line(3,AtLeast,6),Gun_Line(3,AtMost,9)}) -- 6~9
								G_CA_SetSpawn({CVar(FP,UnitIDV1[2],AtLeast,1)},{UID1I},{P_8},{1},"MAX")
								G_CA_SetSpawn({CVar(FP,UnitIDV2[2],AtLeast,1)},{UID2I},{S_5},{1},"MAX")
								G_CA_SetSpawn({CVar(FP,UnitIDV3[2],AtLeast,1)},{UID3I},{P_5},{2},"MAX")
							CIfEnd()
							G_CA_SetSpawn({Gun_Line(3,Exactly,10),CVar(FP,UnitIDV1[2],AtLeast,1)},{UID1I},{S_4},{1},"MAX")
							G_CA_SetSpawn({Gun_Line(3,Exactly,10),CVar(FP,UnitIDV2[2],AtLeast,1)},{UID2I},{P_6},{1},"MAX")
							G_CA_SetSpawn({Gun_Line(3,Exactly,10),CVar(FP,UnitIDV3[2],AtLeast,1)},{UID3I},{S_8},{0},"MAX")
							G_CA_SetSpawn({Gun_Line(3,Exactly,11),CVar(FP,UnitIDV1[2],AtLeast,1)},{UID1I},{P_4},{2},"MAX")
							G_CA_SetSpawn({Gun_Line(3,Exactly,11),CVar(FP,UnitIDV2[2],AtLeast,1)},{UID2I},{P_3},{2},"MAX")
							G_CA_SetSpawn({Gun_Line(3,Exactly,11),CVar(FP,UnitIDV3[2],AtLeast,1)},{UID3I},{S_8},{1},"MAX")
						CIfEnd()
						CIf(FP,Gun_Line(5,Exactly,2)) -- 2nd
							G_CA_SetSpawn({Gun_Line(3,AtMost,1),CVar(FP,UnitIDV1[2],AtLeast,1)},{UID1I},{S_3},{2},"MAX")
							G_CA_SetSpawn({Gun_Line(3,AtMost,1),CVar(FP,UnitIDV2[2],AtLeast,1)},{UID2I},{P_7},{2},"MAX")
							CIf(FP,{Gun_Line(3,AtLeast,2),Gun_Line(3,AtMost,5)}) -- Lv2~5
								G_CA_SetSpawn({CVar(FP,UnitIDV1[2],AtLeast,1)},{UID1I},{S_8},{1},"MAX")
								G_CA_SetSpawn({CVar(FP,UnitIDV2[2],AtLeast,1)},{UID2I},{S_3},{3},"MAX")
								G_CA_SetSpawn({CVar(FP,UnitIDV3[2],AtLeast,1)},{UID3I},{P_6},{1},"MAX")
							CIfEnd()
							CIf(FP,{Gun_Line(3,AtLeast,6),Gun_Line(3,AtMost,9)}) -- 6~9
								G_CA_SetSpawn({CVar(FP,UnitIDV1[2],AtLeast,1)},{UID1I},{P_8},{2},"MAX")
								G_CA_SetSpawn({CVar(FP,UnitIDV2[2],AtLeast,1)},{UID2I},{P_3},{5},"MAX")
								G_CA_SetSpawn({CVar(FP,UnitIDV3[2],AtLeast,1)},{UID3I},{P_8},{1},"MAX")
							CIfEnd()
							G_CA_SetSpawn({Gun_Line(3,Exactly,10),CVar(FP,UnitIDV1[2],AtLeast,1)},{UID1I},{P_7},{1},"MAX")
							G_CA_SetSpawn({Gun_Line(3,Exactly,10),CVar(FP,UnitIDV2[2],AtLeast,1)},{UID2I,UID2I},{S_5,S_6},{0,0},"MAX")
							G_CA_SetSpawn({Gun_Line(3,Exactly,10),CVar(FP,UnitIDV3[2],AtLeast,1)},{UID3I},{P_8},{1},"MAX")
							G_CA_SetSpawn({Gun_Line(3,Exactly,11),CVar(FP,UnitIDV1[2],AtLeast,1)},{UID1I},{S_3},{2},"MAX")
							G_CA_SetSpawn({Gun_Line(3,Exactly,11),CVar(FP,UnitIDV2[2],AtLeast,1)},{UID2I},{P_8},{1},"MAX")
							G_CA_SetSpawn({Gun_Line(3,Exactly,11),CVar(FP,UnitIDV3[2],AtLeast,1)},{UID3I},{P_8},{2},"MAX")
						CIfEnd()
					CIfEnd()
				CIfEnd()
			for i = 0, 11 do
...
--		Radius = Var_TempTable[52]
		...
		Trigger2X(FP,{Gun_Line(3,AtLeast,7),Gun_Line(0,Exactly,156)},{
			CopyCpAction({
				PlayWAVX("staredit\\wav\\H-020.wav"),
				PlayWAVX("staredit\\wav\\H-020.wav"),
				PlayWAVX("staredit\\wav\\H-020.wav")},HumanPlayers,FP),
				SetCDeaths(FP,Add,1,Py_Cond)},{preserved})
		Trigger2X(FP,{Gun_Line(3,AtLeast,7),Gun_Line(0,Exactly,109)},{
			CopyCpAction({
				PlayWAVX("staredit\\wav\\H-020.wav"),
				PlayWAVX("staredit\\wav\\H-020.wav"),
				PlayWAVX("staredit\\wav\\H-020.wav")},HumanPlayers,FP),
				SetCDeaths(FP,Add,1,Sup_Cond)},{preserved})
		Trigger2X(FP,{Gun_Line(3,AtLeast,7),Gun_Line(0,Exactly,173)},{
			CopyCpAction({
	...
	CIf(FP,{Gun_Line(0,Exactly,151)}) -- BdIndex Cerebrate
		CIf(FP,{Gun_Line(3,Exactly,0),Gun_Line(4,Exactly,0),Gun_Line(5,Exactly,0)})
			CDoActions(FP,{Gun_SetLine(4,Add,360)})
	...
	CIf(FP,{Gun_Line(0,Exactly,148)}) -- BdIndex Overmind
		...
		CIf(FP,{Gun_Line(4,AtLeast,360)})
			CIf(FP,CGMode(1))
				G_CA_SetSpawn({Gun_Line(5,Exactly,0)},{21,15},"ACAS",{"Ovrm_X192","Ovrm_X160"},nil,nil,nil,{0,0},"MAX")
				G_CA_SetSpawn({Gun_Line(5,Exactly,0)},{53,48,56},"ACAS",{"Ovrm_X96","Ovrm_X128","Ovrm_X160"},nil,nil,nil,{0,0},"MAX")
				G_CA_SetSpawn({Gun_Line(5,Exactly,1)},{80,87},"ACAS",{"Ovrm_X192","Ovrm_X160"},nil,nil,nil,{0,0},"MAX")
				G_CA_SetSpawn({Gun_Line(5,Exactly,1)},{51,48,57},"ACAS",{"Ovrm_X96","Ovrm_X128","Ovrm_X160"},nil,nil,nil,{0,0},"MAX")
				G_CA_SetSpawn({Gun_Line(5,Exactly,2)},{28,17},"ACAS",{"Ovrm_X192","Ovrm_X160"},nil,nil,nil,{0,0},"MAX")
				G_CA_SetSpawn({Gun_Line(5,Exactly,2)},{51,48,62},"ACAS",{"Ovrm_X96","Ovrm_X128","Ovrm_X160"},nil,nil,nil,{0,0},"MAX")
			CIfEnd()
			CIf(FP,CGMode(2))
				G_CA_SetSpawn({Gun_Line(5,Exactly,0)},{21,15},"ACAS",{"Ovrm_X160","Ovrm_X128"},nil,nil,nil,{0,0},"MAX")
				G_CA_SetSpawn({Gun_Line(5,Exactly,0)},{53,48,56},"ACAS",{"Ovrm_X96","Ovrm_X96","Ovrm_X128"},nil,nil,nil,{0,0},"MAX")
				G_CA_SetSpawn({Gun_Line(5,Exactly,1)},{80,87},"ACAS",{"Ovrm_X160","Ovrm_X128"},nil,nil,nil,{0,0},"MAX")
				G_CA_SetSpawn({Gun_Line(5,Exactly,1)},{51,48,57},"ACAS",{"Ovrm_X96","Ovrm_X96","Ovrm_X128"},nil,nil,nil,{0,0},"MAX")
				G_CA_SetSpawn({Gun_Line(5,Exactly,2)},{28,17},"ACAS",{"Ovrm_X160","Ovrm_X128"},nil,nil,nil,{0,0},"MAX")
				G_CA_SetSpawn({Gun_Line(5,Exactly,2)},{51,48,62},"ACAS",{"Ovrm_X96","Ovrm_X96","Ovrm_X128"},nil,nil,nil,{0,0},"MAX")
			CIfEnd()
			CIf(FP,CGMode(3))
				G_CA_SetSpawn({Gun_Line(5,Exactly,0)},{21,15},"ACAS",{"Ovrm_X128","Ovrm_X96"},nil,nil,nil,{0,0},"MAX")
				G_CA_SetSpawn({Gun_Line(5,Exactly,0)},{53,48,56},"ACAS",{"Ovrm_X64","Ovrm_X64","Ovrm_X96"},nil,nil,nil,{0,0},"MAX")
				G_CA_SetSpawn({Gun_Line(5,Exactly,1)},{80,87},"ACAS",{"Ovrm_X128","Ovrm_X96"},nil,nil,nil,{0,0},"MAX")
				G_CA_SetSpawn({Gun_Line(5,Exactly,1)},{51,48,57},"ACAS",{"Ovrm_X64","Ovrm_X64","Ovrm_X96"},nil,nil,nil,{0,0},"MAX")
				G_CA_SetSpawn({Gun_Line(5,Exactly,2)},{28,17},"ACAS",{"Ovrm_X128","Ovrm_X96"},nil,nil,nil,{0,0},"MAX")
				G_CA_SetSpawn({Gun_Line(5,Exactly,2)},{51,48,62},"ACAS",{"Ovrm_X64","Ovrm_X64","Ovrm_X96"},nil,nil,nil,{0,0},"MAX")
			CIfEnd()
			CDoActions(FP,{Gun_SetLine(4,SetTo,0),Gun_SetLine(5,Add,1)})
		CIfEnd()
		CTrigger(FP,{Gun_Line(54,AtMost,0),Gun_Line(5,AtLeast,3),},{Gun_DoSuspend(),SetCDeaths(FP,Add,1,SPGunCond)},1)	
	...
	CIf(FP,{Gun_Line(0,Exactly,154)}) -- BdIndex Nexus
		...
		CDoActions(FP,{Gun_SetLine(3,Add,1),Gun_SetLine(6,Add,32*4)})
			...
			DoActions2(FP,CopyCpAction({RunAIScript("Turn ON Shared Vision for Player 7")},MapPlayers,FP))
		CIfEnd()
		...
		DoActions2X(FP,{CopyCpAction({RunAIScript("Turn OFF Shared Vision for Player 7")},MapPlayers,FP),SetCDeaths(FP,Add,1,SPGunCond)})
		CIfEnd()
	...
	CIf(FP,{Gun_Line(0,Exactly,200)}) -- BdIndex Generator
		CIf(FP,{Gun_Line(3,Exactly,0),Gun_Line(4,Exactly,0),Gun_Line(5,Exactly,0)})
			...
			DoActions2(FP,CopyCpAction({RunAIScript("Turn ON Shared Vision for Player 8")},MapPlayers,FP))
		CIfEnd()
		CTrigger(FP,{Gun_Line(4,Exactly,500)},{Gun_SetLine(3,Add,1)})
		CTrigger(FP,{Gun_Line(4,Exactly,1000)},{Gun_SetLine(3,Add,1)})
		...
		CIf(FP,{Gun_Line(54,AtMost,0),Gun_Line(4,AtLeast,1100),})
		CDoActions(FP,{Gun_DoSuspend()})
		DoActions2X(FP,{CopyCpAction({RunAIScript("Turn OFF Shared Vision for Player 8")},MapPlayers,FP),SetCDeaths(FP,Add,1,SPGunCond)})
		CIfEnd()
	CIfEnd()
	...
	CIf(FP,{Gun_Line(0,Exactly,1000)}) -- BdIndex GunBoss
		...
		for j = 2, 3 do
			...
			for c = 1, 4 do
				G_CA_SetSpawn({CGMode(j),CVar(FP,UnitIDV1[2],AtLeast,1)},{UID1I},"ACAS","GB_"..Dif.."1_"..c,nil,189,nil,{0,0},"MAX")
				G_CA_SetSpawn({CGMode(j),CVar(FP,UnitIDV2[2],AtLeast,1)},{69,27},"ACAS","GB_"..Dif.."2_"..c,nil,189,nil,{0,0},"MAX")
			end
		end
