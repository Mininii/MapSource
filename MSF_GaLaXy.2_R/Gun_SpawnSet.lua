...
--		Radius = Var_TempTable[52]
	...
	CIf(FP,{Gun_Line(0,Exactly,148)}) -- BdIndex Overmind
		...
		CIf(FP,{Gun_Line(4,AtLeast,360)})
			CIf(FP,CGMode(1))
				G_CA_SetSpawn({Gun_Line(5,Exactly,0)},{21,15},"ACAS",{"Ovrm_X192","Ovrm_X160"},"MAX",nil,nil,{0,0})
				G_CA_SetSpawn({Gun_Line(5,Exactly,0)},{53,48,56},"ACAS",{"Ovrm_X96","Ovrm_X128","Ovrm_X160"},"MAX",nil,nil,{0,0})
				G_CA_SetSpawn({Gun_Line(5,Exactly,1)},{80,87},"ACAS",{"Ovrm_X192","Ovrm_X160"},"MAX",nil,nil,{0,0})
				G_CA_SetSpawn({Gun_Line(5,Exactly,1)},{51,48,57},"ACAS",{"Ovrm_X96","Ovrm_X128","Ovrm_X160"},"MAX",nil,nil,{0,0})
				G_CA_SetSpawn({Gun_Line(5,Exactly,2)},{28,17},"ACAS",{"Ovrm_X192","Ovrm_X160"},"MAX",nil,nil,{0,0})
				G_CA_SetSpawn({Gun_Line(5,Exactly,2)},{51,48,62},"ACAS",{"Ovrm_X96","Ovrm_X128","Ovrm_X160"},"MAX",nil,nil,{0,0})
			CIfEnd()
			CIf(FP,CGMode(2))
				G_CA_SetSpawn({Gun_Line(5,Exactly,0)},{21,15},"ACAS",{"Ovrm_X160","Ovrm_X128"},"MAX",nil,nil,{0,0})
				G_CA_SetSpawn({Gun_Line(5,Exactly,0)},{53,48,56},"ACAS",{"Ovrm_X96","Ovrm_X96","Ovrm_X128"},"MAX",nil,nil,{0,0})
				G_CA_SetSpawn({Gun_Line(5,Exactly,1)},{80,87},"ACAS",{"Ovrm_X160","Ovrm_X128"},"MAX",nil,nil,{0,0})
				G_CA_SetSpawn({Gun_Line(5,Exactly,1)},{51,48,57},"ACAS",{"Ovrm_X96","Ovrm_X96","Ovrm_X128"},"MAX",nil,nil,{0,0})
				G_CA_SetSpawn({Gun_Line(5,Exactly,2)},{28,17},"ACAS",{"Ovrm_X160","Ovrm_X128"},"MAX",nil,nil,{0,0})
				G_CA_SetSpawn({Gun_Line(5,Exactly,2)},{51,48,62},"ACAS",{"Ovrm_X96","Ovrm_X96","Ovrm_X128"},"MAX",nil,nil,{0,0})
			CIfEnd()
			CIf(FP,CGMode(3))
				G_CA_SetSpawn({Gun_Line(5,Exactly,0)},{21,15},"ACAS",{"Ovrm_X128","Ovrm_X96"},"MAX",nil,nil,{0,0})
				G_CA_SetSpawn({Gun_Line(5,Exactly,0)},{53,48,56},"ACAS",{"Ovrm_X64","Ovrm_X64","Ovrm_X96"},"MAX",nil,nil,{0,0})
				G_CA_SetSpawn({Gun_Line(5,Exactly,1)},{80,87},"ACAS",{"Ovrm_X128","Ovrm_X96"},"MAX",nil,nil,{0,0})
				G_CA_SetSpawn({Gun_Line(5,Exactly,1)},{51,48,57},"ACAS",{"Ovrm_X64","Ovrm_X64","Ovrm_X96"},"MAX",nil,nil,{0,0})
				G_CA_SetSpawn({Gun_Line(5,Exactly,2)},{28,17},"ACAS",{"Ovrm_X128","Ovrm_X96"},"MAX",nil,nil,{0,0})
				G_CA_SetSpawn({Gun_Line(5,Exactly,2)},{51,48,62},"ACAS",{"Ovrm_X64","Ovrm_X64","Ovrm_X96"},"MAX",nil,nil,{0,0})
			CIfEnd()
			CDoActions(FP,{Gun_SetLine(4,SetTo,0),Gun_SetLine(5,Add,1)})
		CIfEnd()
		CTrigger(FP,{Gun_Line(54,AtMost,0),Gun_Line(5,AtLeast,3),},{Gun_DoSuspend(),SetCDeaths(FP,Add,1,SPGunCond)},1)	
	...
	CIf(FP,{Gun_Line(0,Exactly,1000)}) -- BdIndex GunBoss
		...
		for j = 2, 3 do
			...
			for c = 1, 4 do
				G_CA_SetSpawn({CGMode(j),CVar(FP,UnitIDV1[2],AtLeast,1)},{UID1I},"ACAS","GB_"..Dif.."1_"..c,"MAX",187,nil,{0,0})
				G_CA_SetSpawn({CGMode(j),CVar(FP,UnitIDV2[2],AtLeast,1)},{69,27},"ACAS","GB_"..Dif.."2_"..c,"MAX",187,nil,{0,0})
			end
		end
