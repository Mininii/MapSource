...
function GunWave(GunID,LocID,NUTable,BGMTypes,G_CA_args)
	...
	MB5 = CreateCcode()
	Trigger2X(FP,{Bring(FP, AtMost, 0, 151, 8)},{RotatePlayer({PlayWAVX("sound\\Bullet\\TNsFir00.wav"),PlayWAVX("sound\\Bullet\\TNsFir00.wav"),PlayWAVX("sound\\Bullet\\TNsFir00.wav"),DisplayTextX(StrDesignX("\x04정신체 파괴! + 50,000 Pts"),4),DisplayTextX(StrDesignX("\x04이제부터 더 강력한 몬스터가 출현합니다."),4)}, HumanPlayers, FP),SetV(BGMType,5),SetScore(Force1, Add, 50000, Kills),SetCD(WaveS[2],1),SetInvincibility(Disable, 201, FP, 10)})
	Trigger2X(FP,{Bring(FP, AtMost, 0, 151, 9)},{RotatePlayer({PlayWAVX("sound\\Bullet\\TNsFir00.wav"),PlayWAVX("sound\\Bullet\\TNsFir00.wav"),PlayWAVX("sound\\Bullet\\TNsFir00.wav"),DisplayTextX(StrDesignX("\x04정신체 파괴! + 50,000 Pts"),4),DisplayTextX(StrDesignX("\x04이제부터 더 강력한 몬스터가 출현합니다."),4)}, HumanPlayers, FP),SetV(BGMType,5),SetScore(Force1, Add, 50000, Kills),SetCD(WaveS[3],1),SetInvincibility(Disable, 201, FP, 11)})
	Trigger2X(FP,{Bring(FP, AtMost, 0, 201, 10)},{RotatePlayer({PlayWAVX("sound\\Bullet\\TNsFir00.wav"),PlayWAVX("sound\\Bullet\\TNsFir00.wav"),PlayWAVX("sound\\Bullet\\TNsFir00.wav"),DisplayTextX(StrDesignX("\x04초월체 고치 파괴! + 80,000 Pts"),4),DisplayTextX(StrDesignX("\x04이제부터 더 강력한 몬스터가 출현합니다."),4)}, HumanPlayers, FP),SetV(BGMType,5),SetScore(Force1, Add, 80000, Kills),SetCD(WaveS[4],1),SetInvincibility(Disable, 152, FP, 12)})
	Trigger2X(FP,{Bring(FP, AtMost, 0, 201, 11)},{RotatePlayer({PlayWAVX("sound\\Bullet\\TNsFir00.wav"),PlayWAVX("sound\\Bullet\\TNsFir00.wav"),PlayWAVX("sound\\Bullet\\TNsFir00.wav"),DisplayTextX(StrDesignX("\x04초월체 고치 파괴! + 80,000 Pts"),4),DisplayTextX(StrDesignX("\x04이제부터 더 강력한 몬스터가 출현합니다."),4)}, HumanPlayers, FP),SetV(BGMType,5),SetScore(Force1, Add, 80000, Kills),SetCD(WaveS[5],1),SetInvincibility(Disable, 152, FP, 13)})
	...
	for i = 14,1,-1 do
		CTrigger(FP, {TMemory(_Add(MBPtr[2],2),AtMost,(100*i)*256)}, {CreateUnit(10, 84, 1, FP),KillUnit(84, FP),CreateUnitWithProperties(1, 74, 1, FP,{invincible = true})})
	end
	CIfEnd()
	...
	TriggerX(FP, {Deaths(FP, AtLeast, 1, 95)}, {RotatePlayer({PlayWAVX("staredit\\wav\\Bosskill.ogg"),PlayWAVX("staredit\\wav\\Bosskill.ogg"),PlayWAVX("staredit\\wav\\Bosskill.ogg"),DisplayTextX(StrDesignX("\x04중간보스 \x03라그나사우르 \x07처치!!! \x1F+ 500,000 Pts"), 4)}, HumanPlayers, FP),SetScore(Force1, Add, 500000, Kills)})
	TriggerX(FP, {Deaths(FP, AtLeast, 1, 89)}, {RotatePlayer({PlayWAVX("staredit\\wav\\Bosskill.ogg"),PlayWAVX("staredit\\wav\\Bosskill.ogg"),PlayWAVX("staredit\\wav\\Bosskill.ogg"),DisplayTextX(StrDesignX("\x04중간보스 \x03라이나돈 \x07처치!!! \x1F+ 500,000 Pts"), 4)}, HumanPlayers, FP),SetScore(Force1, Add, 500000, Kills),KillUnit(74, FP)})
	TriggerX(FP, {Deaths(FP, AtLeast, 1, 96)}, {RotatePlayer({PlayWAVX("staredit\\wav\\Bosskill.ogg"),PlayWAVX("staredit\\wav\\Bosskill.ogg"),PlayWAVX("staredit\\wav\\Bosskill.ogg"),DisplayTextX(StrDesignX("\x04중간보스 \x03우르사돈 \x07처치!!! \x1F+ 500,000 Pts"), 4)}, HumanPlayers, FP),SetScore(Force1, Add, 500000, Kills)})
	TriggerX(FP, {Deaths(FP, AtLeast, 1, 90)}, {RotatePlayer({PlayWAVX("staredit\\wav\\Bosskill.ogg"),PlayWAVX("staredit\\wav\\Bosskill.ogg"),PlayWAVX("staredit\\wav\\Bosskill.ogg"),DisplayTextX(StrDesignX("\x04중간보스 \x03벤갈라스 \x07처치!!! \x1F+ 500,000 Pts"), 4)}, HumanPlayers, FP),SetScore(Force1, Add, 500000, Kills)})
	...
	GetLocCenter(48, G_CA_X, G_CA_Y)
		G_CA_SetSpawn({}, {88,77}, "ACAS", "Cir5", "MAX", nil, nil, nil, FP, 1)
	...
	GetLocCenter(48, G_CA_X, G_CA_Y)
		G_CA_SetSpawn({}, {21,17}, "ACAS", "Cir4", "MAX", nil, nil, nil, FP, 1)
		DoActions(FP, {Order("Any unit", FP, 64, Attack, 49)})
	CIfEnd()
	...
	GetLocCenter(48, G_CA_X, G_CA_Y)
		G_CA_SetSpawn({}, {88,78}, "ACAS", "Cir3", "MAX", nil, nil, nil, FP, 1)
		DoActions(FP, {Order("Any unit", FP, 64, Attack, 49)})
	CIfEnd()
	...
	GetLocCenter(48, G_CA_X, G_CA_Y)
		G_CA_SetSpawn({}, {21,19}, "ACAS", "Cir5", "MAX", nil, nil, nil, FP, 1)
		DoActions(FP, {Order("Any unit", FP, 64, Attack, 49)})
	CIfEnd()
	...
	GetLocCenter(48, G_CA_X, G_CA_Y)
		G_CA_SetSpawn({}, {28,25}, "ACAS", "Cir4", "MAX", nil, nil, nil, FP, 1)
		DoActions(FP, {Order("Any unit", FP, 64, Attack, 49)})
	CIfEnd()
	...
	GetLocCenter(48, G_CA_X, G_CA_Y)
		G_CA_SetSpawn({}, {29,10}, "ACAS", "Cir3", "MAX", nil, nil, nil, FP, 1)
		DoActions(FP, {Order("Any unit", FP, 64, Attack, 49)})
	CIfEnd()
	...
	GetLocCenter(48, G_CA_X, G_CA_Y)
		G_CA_SetSpawn({}, {98,79}, "ACAS", "Cir5", "MAX", nil, nil, nil, FP, 1)
		DoActions(FP, {Order("Any unit", FP, 64, Attack, 49)})
	CIfEnd()
