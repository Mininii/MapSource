...
NJumpEnd(FP, EnemyArea)
	...
	G_CA_SetSpawn({CD(UTAGECcode,1,AtLeast),CV(TrapNum,10)}, {23,75}, {P_3,S_3}, {4,2}, "MAX", 1, nil, nil, FP)
	...
	f_TempRepeat({CD(UTAGECcode,1,AtLeast)}, 21, 1, 188, FP, {1536,1920})
	f_TempRepeat({CD(UTAGECcode,1,AtLeast)}, 88, 1, 188, FP, {1536,1920})
	f_LoadCp()
