...
CIfX(FP,{CV(G_CA_X2Option,1)})
CMov(FP,Repeat_TempV,4)
CElseX()
...
function Install_Load_CAPlot()
	...
	for j, k in pairs(G_CA_CallStack) do
		CallTriggerX(FP,k[1],{CVar(FP,G_CA_Temp[4][2],Exactly,j,0xFF)},{SetV(G_CA_X2Option, k[2])})
	end
	SetCallEnd()
end
