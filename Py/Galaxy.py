		...
		if EUDIf()((Command(AllPlayers,AtLeast,1,186))):
			...
			if EUDIf()((Switch("Switch 211",Set))):
				if EUDIf()((DeathsX(B5H+17,Exactly,0,0,0xFF00))):
					DoActions([SetDeathsX(B5H+17,SetTo,2*256,0,0xFF00),SetDeaths(B5H+21,SetTo,0,0),SetDeaths(B5H+4,SetTo,f_maskread_epd(B5H+8,0xFFFFFFFF),0),SetDeaths(B5H+2,SetTo,f_maskread_epd(B5H+8,0xFFFFFFFF),0),SetDeaths(B5H+20,SetTo,f_maskread_epd(B5H+8,0xFFFFFFFF),0),SetDeaths(B5H,SetTo,7000000*256,0)])
				EUDEndIf()
			EUDEndIf()
		EUDEndIf()
	EUDEndIf()
