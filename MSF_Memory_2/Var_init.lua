function Var_init()
	...
	CreateUnitQueUIDArr = Create_VoidEPDHeaderV(FP,4*5000)
	CreateUnitQueXPosArr = Create_VoidEPDHeaderV(FP,4*5000)
	CreateUnitQueYPosArr = Create_VoidEPDHeaderV(FP,4*5000)
	CreateUnitQueOXPosArr = Create_VoidEPDHeaderV(FP,4*5000)
	CreateUnitQueOYPosArr = Create_VoidEPDHeaderV(FP,4*5000)
	CreateUnitQuePlayerArr = Create_VoidEPDHeaderV(FP,4*5000)
	CreateUnitQueFlagArr = Create_VoidEPDHeaderV(FP,4*5000)
