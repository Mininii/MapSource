function Var_init()
	...
	CreateHeroPointArr(10,"\x1F화\x04염 "..Conv_HStr("<1F>I<04>nferno"),30000)
	...
	CreateHeroPointArr(71,"\x1F고\x04통 "..Conv_HStr("<1F>P<4>ain"),30000)
	CreateHeroPointArr(63,"\x1F보\x04주 "..Conv_HStr("<1F>D<4>ark <1F>O<4>rb"),30000)
	CreateHeroPointArr(76,"\x1B보\x04옥 "..Conv_HStr("<1B>O<4>rb"),30000)
	CreateHeroPointArr(67,"\x1F창\x04세자 "..Conv_HStr("<1F>G<4>enesis"),30000)
	...
	CreateHeroPointArr(61,"\x1F변\x04명자 "..Conv_HStr("<1F>V<4>indication"),30000)
	...
	CreateHeroPointArr(27,"\x1F승\x04천자 "..Conv_HStr("<1F>A<4>scension"),30000)
	CreateHeroPointArr(29,"\x1F기\x04함 "..Conv_HStr("<1F>N<4>orad <1F>II"),30000)
	CreateHeroPointArr(23,"\x1F우\x04상 "..Conv_HStr("<1F>I<4>conoclasm"),30000)
	CreateHeroPointArr(79,"\x1B불\x04사자 "..Conv_HStr("<1B>T<4>assadar"),30000)
	CreateHeroPointArr(81,"\x1F공\x04작 "..Conv_HStr("<1F>D<4>antalion"),30000)
	CreateHeroPointArr(162,"\x1F증\x04오자 "..Conv_HStr("<1F>H<4>ate"),30000)
	CreateHeroPointArr(98,"\x1F위\x04반자 "..Conv_HStr("<1F>B<4>reach"),30000)
	CreateHeroPointArr(68,"\x1F집\x04행관 "..Conv_HStr("<1F>J<4>udgment"),30000)
	CreateHeroPointArr(65,"\x1F광\x04전사 "..Conv_HStr("<1F>M<4>adness"),30000)
	CreateHeroPointArr(66,"\x1F영\x04생자 "..Conv_HStr("<1F>I<4>mmortal"),30000)
	CreateHeroPointArr(57,"\x1F마\x04녀 "..Conv_HStr("<1F>W<4>itch"),30000)
	CreateHeroPointArr(52,"\x1B부\x04패 "..Conv_HStr("<1B>O<4>rganes"),30000)
	CreateHeroPointArr(8,"\x1F유\x04령 "..Conv_HStr("<1F>P<04>hantom"),30000)
	CreateHeroPointArr(3,"\x1F무\x04법자 "..Conv_HStr("<1F>B<04>rutal"),30000)
	CreateHeroPointArr(80,"\x1F균\x04형 "..Conv_HStr("<1F>E<4>quilibrium"),30000)
	CreateHeroPointArr(102,"\x1F대\x04립자 "..Conv_HStr("<1F>C<4>onflict"),30000)
	CreateHeroPointArr(60,"\x08적\x04대자 "..Conv_HStr("<08>A<4>ntagonism"),30000)
	CreateHeroPointArr(30,"\x1F정\x04체성 "..Conv_HStr("<1F>I<4>dentity"),30000)
