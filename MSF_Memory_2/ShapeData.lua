...
TesCircleSh = CSMakeCircle(30, 384, 0, 31, 1)
TesLine=CSMakeLine(1, 64, 0, 25, 0)
TesCircleShL = CSMakeCircle(90, 32*50, 0, 91, 1)
sq = 2048-(32*5)
...
tes_Eff2 = CSMakeFillPathXY(2048, 192)
CircleA = CSMakeCircle(6,90,0,PlotSizeCalc(6, 3),PlotSizeCalc(6, 2))
EllipseB = CS_Distortion(CircleA,{5,0},{5,0},nil,nil)
tes_EllipseN = CS_Rotate(CS_MoveXY(EllipseB,1600,0), -90)
--------------------------------------------------------------
	...
	G_GBShT = {}
	for i = 12, 4, -1 do
		_G["tesCSh"..i] = CSMakePolygon(i, 32, 0, PlotSizeCalc(i, 9), PlotSizeCalc(i, 8))
