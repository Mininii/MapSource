...
Trigger2X(i,{Kills(i,AtLeast,1,150)},{SetKills(i,Subtract,1,150),SetScore(i,Add,50000,Kills),DisplayText("\x0D\x0D!H"..StrDesignX2(Conv_HStr("<19>B<04>onus").."\x04 직접 파괴 \x07보너스 \x1F＋"..N_to_EmN(50000).." \x1FＰｔｓ"),4)},{preserved})
Trigger2X(i,{Kills(i,AtLeast,1,176)},{SetKills(i,Subtract,1,176),SetScore(i,Add,30000,Kills),DisplayText("\x0D\x0D!H"..StrDesignX2(Conv_HStr("<1D>F<4>it").."\x04 직접 파괴 \x07보너스 \x1F＋"..N_to_EmN(30000).." \x1FＰｔｓ"),4)},{preserved})
Trigger2X(i,{Kills(i,AtLeast,1,177)},{SetKills(i,Subtract,1,177),SetScore(i,Add,30000,Kills),DisplayText("\x0D\x0D!H"..StrDesignX2(Conv_HStr("<1D>F<4>it").."\x04 직접 파괴 \x07보너스 \x1F＋"..N_to_EmN(30000).." \x1FＰｔｓ"),4)},{preserved})
Trigger2X(i,{Kills(i,AtLeast,1,178)},{SetKills(i,Subtract,1,178),SetScore(i,Add,30000,Kills),DisplayText("\x0D\x0D!H"..StrDesignX2(Conv_HStr("<1D>F<4>it").."\x04 직접 파괴 \x07보너스 \x1F＋"..N_to_EmN(30000).." \x1FＰｔｓ"),4)},{preserved})
...
BT = {
	"\x07·\x11·\x08·\x11《 \x10Ｄ\x04ｉｖｉｄｅ \x11》\x08·\x11·\x07·",
	"\x07·\x11·\x08·\x11《 \x15Ｔ\x04ｅｎｅｂｒｉｓ \x11》\x08·\x11·\x07·",
	"\x07·\x11·\x08·\x11《 \x18Ｄ\x04ｅｍｉｓｅ \x11》\x08·\x11·\x07·",
	"\x07·\x11·\x08·\x11《 \x1BＡ\x04ｎｏｍａｌｙ \x11》\x08·\x11·\x07·"
}
BT2 = {
	"\x07·\x11·\x08·\x11《 \x1FＩ\x04nfinite \x10Ｄ\x04ivide, \x11》\x08·\x11·\x07·",
	"\x07·\x11·\x08·\x11《 \x10Ｐ\x04entiment in \x15Ｔ\x04enebris \x11》\x08·\x11·\x07·",
	"\x07·\x11·\x08·\x11《 \x19Ｗ\x04orld \x18Ｄ\x04emication \x11》\x08·\x11·\x07·",
	"\x07·\x11·\x08·\x11《 \x1CＡ\x04rcana \x1BＡ\x04nomaly \x11》\x08·\x11·\x07·"
}
BStr= {}
BStra= {}
BStrs= {}
