function Opening()
	...
	for i=1, 57 do
        Trigger2X(FP,{CDeaths(FP,AtLeast,i*15,OPCCode);},{RotatePlayer(
			...
			DisplayExtText("\x0D\x0D\x13\x04"..string.rep("―", i),4);
			DisplayExtText("\x0D\x0D\n\x0D\x0D\n\x0D\x0D\n\x0D\x0D\n\x0D\x0D\n",4);
			DisplayExtText("\x0D\x0D\x13\x04"..string.rep("―", i),4);
			DisplayExtText("\x0D\x0D\n\x0D\x0D\n",4);
        },HumanPlayers,FP)})
...
Trigger2X(FP,{CDeaths(FP,AtLeast,956,OPCCode);},{RotatePlayer(
    {DisplayExtText(string.rep("\x0D\x0D\n", 10),4);
    DisplayExtText("\x0D\x0D\n",4);
    DisplayExtText("\x0D\x0D\x13\x04"..string.rep("―", 57),4);
    DisplayExtText("\x0D\x0D\x13\x06== \x04마린키우기 \x07Ｍｅｍｏｒｙ_２ \x06==\x0D\x0D\n\x0D\x0D\n\x0D\x0D\x13\x02"..VerText.."\x0D\x0D\n\x0D\x0D\n\x0D\x0D\x13\x1FSTRCtrig \x04Assembler \x07v5.4\x04, \x1FCB \x16Paint \x07v2.4 \x04in Used \x19(つ>ㅅ<)つ",4);
    DisplayExtText("\x0D\x0D\x13\x04"..string.rep("―", 57),4);
...
EDText = {
    ...
    "\x10Ｎｏｒｍａｌ　\x0FＥ\x04ｎｄｉｎｇ ３ ： \x10망각\x04의 \x08운명",
    "\x1FＨｉｄｄｅｎ　\x0FＥ\x04ｎｄｉｎｇ ４ ： \x1F기억세계\x04의 \x10붕괴",
}
...
Trigger2X(FP,{CD(Win,500,AtLeast),CD(EDNum,i)},
    RotatePlayer({
        DisplayExtText(string.rep("\x0D\x0D\n", 10),4),
        DisplayExtText("\x0D\x0D\x13\x04"..string.rep("―", 56),4),
        DisplayExtText("\x0D\x0D\x13\x06== \x04마린키우기 \x07Ｍｅｍｏｒｙ_２ \x06==\x0D\x0D\n\x0D\x0D\x13\x07＝\x04The Wonderful Abstractions of a Lost Memory\x07＝ \x0D\x0D\n\x0D\x0D\x13\x10클리어\x04 하셨습니다.",4),
        DisplayExtText("\x0D\x0D\x13"..EDText[i],4),
        DisplayExtText("\x0D\x0D\x13\x1FSTRCtrig \x04Assembler \x07v5.4\x04, \x1FCB \x16Paint \x07v2.4 \x04in Used \x19(つ>ㅅ<)つ",4),
        DisplayExtText("\x0D\x0D\x13\x04"..string.rep("―", 56),4),
...
RotatePlayer({DisplayExtText(StrDesignX("\x04총합 \x08데스 카운트\x04가 \x06400 이상\x04입니다. 다시 도전해주세요."),4),
