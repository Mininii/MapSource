...
Trigger2X(FP,{CD(Win,500,AtLeast),CD(EDNum,i)},
    RotatePlayer({
        ...
        DisplayTextX("\x0D\x0D\x13\x1FSTRCtrig \x04Assembler \x07v5.4\x04, \x1FCB \x16Paint \x07v2.4 \x04in Used \x19(つ>ㅅ<)つ",4),
        DisplayTextX("\x0D\x0D\x13\x04"..string.rep("―", 56),4),
