function Install_boss()
	CIf({Force1,FP},{Deaths(P12,AtMost,0,186),CGMode(2,AtLeast),CDeaths(FP,AtLeast,6000,GunBossAct),Bring(Force2, AtMost, 0, "Protoss Temple", 64)},{SetCDeaths(FP,SetTo,1,BossStart),ModifyUnitShields(All,186,FP,64,100)})
		...
		CIf(FP,{CVar(FP,FBH[2],AtLeast,1),CVar(FP,FBH[2],AtMost,19025+(84*1699))})
			...
			CTrigger(FP,{TMemory(FBH,AtMost,6000000*256)},{CopyCPAction({PlayWAVX("staredit\\wav\\HeroKill.ogg"),PlayWAVX("staredit\\wav\\HeroKill.ogg")},HumanPlayers,FP),SetCDeaths(FP,SetTo,300,BT_0),SetCDeaths(FP,Add,1,B_P),SetCDeaths(FP,SetTo,1,BT_Ready2)})
			CTrigger(FP,{TMemory(FBH,AtMost,4000000*256)},{CopyCPAction({PlayWAVX("staredit\\wav\\HeroKill.ogg"),PlayWAVX("staredit\\wav\\HeroKill.ogg")},HumanPlayers,FP),SetCDeaths(FP,SetTo,300,BT_0),SetCDeaths(FP,Add,1,B_P),SetCDeaths(FP,SetTo,1,BT_Ready2)})
			CTrigger(FP,{TMemory(FBH,AtMost,2000000*256)},{CopyCPAction({PlayWAVX("staredit\\wav\\HeroKill.ogg"),PlayWAVX("staredit\\wav\\HeroKill.ogg")},HumanPlayers,FP),SetCDeaths(FP,SetTo,300,BT_0),SetCDeaths(FP,Add,1,B_P),SetCDeaths(FP,SetTo,1,BT_Ready2)})
			CIfEnd()
		...
		CIfX(FP,{CountdownTimer(AtMost,0),CDeaths(FP,AtMost,0,BT_0)},{SetInvincibility(Disable,186,FP,64)})
			...
			CIf(FP,CDeaths(FP,Exactly,0,B_P))
				...
				for i = 0, 3 do
				G_CA_SetSpawn({CDeaths(FP,Exactly,0,BT1),CDeaths(FP,Exactly,i,BR)},{204},{"ACAS"},{BRT[i+1]},"MAX",nil,nil,{1024,2400})
				end
			...
			CIf(FP,CDeaths(FP,Exactly,1,B_P),{SetCDeaths(FP,Add,1,BT2)})
			...
			CIfEnd()
			CIf(FP,CDeaths(FP,Exactly,3,B_P),{})
...
BClearT = "\n\n\n\n\n\n\n\n\n\n\n\x13\x08※※※※※※※※※※※※\x07 N O T I C E\x08 ※※※※※※※※※※※※\n\n\n\x13\x08최후의 적 \x0FU\x04nknown\x08.2 \x04를 \x04쓰러트렸습니다.\n\n\n\x13\x08※※※※※※※※※※※※\x07 N O T I C E\x08 ※※※※※※※※※※※※"
	Trigger2X(FP,{CountdownTimer(AtMost,0),CVar(FP,FBH[2],Exactly,0)},{CopyCPAction({DisplayTextX(BClearT,4),PlayWAVX("staredit\\wav\\clear.ogg"),PlayWAVX("staredit\\wav\\clear.ogg"),PlayWAVX("staredit\\wav\\clear.ogg")},HumanPlayers,FP),SetSwitch("Switch 130",Set),SetDeaths(P12,SetTo,1,186),SetCDeaths(FP,SetTo,1,Win)},{Preserved})
		G_CA_SetSpawn({CDeaths(FP,Exactly,1,BT_Ready2),CGMode(2)},{84},{P_6},{0},"MAX",nil,nil,{1024,2400})
		G_CA_SetSpawn({CDeaths(FP,Exactly,1,BT_Ready2),CGMode(3)},{84},{S_8},{2},nil,nil,nil,{1024,2400})
