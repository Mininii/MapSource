function Install_Shape()
	...
	Py1FN = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,5*5,0),1,0.5),1024,1760)
	Py2FN = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,5*5,0),1,0.5),1536,1440)
	Py3FN = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,5*5,0),1,0.5),2048,1760)
	Py4FN = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,5*5,0),1,0.5),2560,1440)
	Py5FN = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,5*5,0),1,0.5),3072,1760)

	Su1FN = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,5*5,0),1,0.5),1024,1376)
	Su2FN = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,5*5,0),1,0.5),1536,1824)
	Su3FN = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,5*5,0),1,0.5),2048,1376)
	Su4FN = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,5*5,0),1,0.5),2560,1824)
	Su5FN = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,5*5,0),1,0.5),3072,1376)

	Py1FH = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,7*7,0),1,0.5),1024,1760)
	Py2FH = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,7*7,0),1,0.5),1536,1440)
	Py3FH = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,7*7,0),1,0.5),2048,1760)
	Py4FH = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,7*7,0),1,0.5),2560,1440)
	Py5FH = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,7*7,0),1,0.5),3072,1760)

	Su1FH = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,7*7,0),1,0.5),1024,1376)
	Su2FH = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,7*7,0),1,0.5),1536,1824)
	Su3FH = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,7*7,0),1,0.5),2048,1376)
	Su4FH = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,7*7,0),1,0.5),2560,1824)
	Su5FH = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,7*7,0),1,0.5),3072,1376)

	Py1FB = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,9*9,0),1,0.5),1024,1760)
	Py2FB = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,9*9,0),1,0.5),1536,1440)
	Py3FB = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,9*9,0),1,0.5),2048,1760)
	Py4FB = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,9*9,0),1,0.5),2560,1440)
	Py5FB = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,9*9,0),1,0.5),3072,1760)

	Su1FB = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,9*9,0),1,0.5),1024,1376)
	Su2FB = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,9*9,0),1,0.5),1536,1824)
	Su3FB = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,9*9,0),1,0.5),2048,1376)
	Su4FB = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,9*9,0),1,0.5),2560,1824)
	Su5FB = CS_MoveCenter(CS_RatioXY(CSMakeStar(4,180,75,45,9*9,0),1,0.5),3072,1376)
