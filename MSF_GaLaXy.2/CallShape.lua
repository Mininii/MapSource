function Install_Shape()
	...
	Chry = {4   ,{192, 2176},{512, 2016},{1792, 2656},{1472, 2816}}

	Chry_A = CS_ConnectPathX(CSMakePath({832,2176},{512,2336}),64,0)
	Chry_B = CS_ConnectPathX(CSMakePath({1152,2336},{832,2496}),64,0)
	Chry_C = CS_ConnectPathX(CSMakePath({1472,2496},{1152,2656}),64,0)
	Chry_D = CS_ConnectPathX(Chry,64,1)
	
	Chry_N = CS_Merge(CS_Merge(Chry_A,Chry_B,32,0),CS_Merge(Chry_C,Chry_D,32,0),32,0)
