...
function Trigger(args)
	...
	local function bwrite(byte)
		TRIGStr = TRIGStr..string.char(byte)
	end
	local function wwrite(word)
		TRIGStr = TRIGStr..string.char(bit32.band(word,0xFF))
		TRIGStr = TRIGStr..string.char(bit32.rshift(bit32.band(word,0xFF00),8))
	end
	local function dwwrite(dword)
		TRIGStr = TRIGStr..string.char(bit32.band(dword,0xFF))
		TRIGStr = TRIGStr..string.char(bit32.rshift(bit32.band(dword,0xFF00),8))
		TRIGStr = TRIGStr..string.char(bit32.rshift(bit32.band(dword,0xFF0000),16))
		TRIGStr = TRIGStr..string.char(bit32.rshift(bit32.band(dword,0xFF000000),24))
	end
    ...
    if CCount > 0 then
        TRIGStr = TRIGStr..__VoidCondArr[CCount]
    end
    ...
    if args.actions then
        ...
        for k, v in pairs(args.actions) do
        	...
        	if v[10] >= 0x80 then
        		...
        		bwrite(v[10])
        		TRIGStr = TRIGStr.."\0\0\0"
        	end
        end
    end
    if ACount > 0 then
        TRIGStr = TRIGStr..__VoidActArr[ACount]
    end
    ...
    if args.players then
        ...
        TRIGStr = TRIGStr.."\0\0\0\0\0\0"
        __TRIGChkptr:write(TRIGStr)
    end
